...
export const Donut = (props: Props) => (
  <Shape viewBox="0 0 90 90" xmlns="http://www.w3.org/2000/svg" color="coral" {...props}>
...
export const L = (props: Props) => (
  <Shape viewBox="0 0 55 89" xmlns="http://www.w3.org/2000/svg" color="hotpink" {...props}>
...
export const Dice = (props: Props) => (
  <Shape viewBox="0 0 92 92" xmlns="http://www.w3.org/2000/svg" color="olive" {...props}>
